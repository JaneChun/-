...
export default function Form({ addDiscussion }) {
        ...
        <div className='form__input--wrapper'>
          ...
          <div className='textbox_and_button'>
            <div className='form__textbox'>
              ...
              <textarea onChange={handleTextareaChange} id='story' name='story' placeholder='질문을 작성하세요.' required></textarea>
            </div>
            <div className='form__submit'>
              <button onClick={onButtonClick} type='submit' className='submit_btn'>
